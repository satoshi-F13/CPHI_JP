...
This dashboard provides comprehensive analysis of **CPHI Japan**, Asian premier pharmaceutical exhibition.

**Coverage:** 2024-2026\
**Last Updated:** `r Sys.Date()`\
**Source:** CPHI Japan Report

------------------------------------------------------------------------

### Key Highlights

📊 **`r format(793, big.mark=",")`** Exhibitors (2025)\
👥 **`r format(34128, big.mark=",")`** Visitors (2025)\
🌍 **32** Countries Represented\
📈 **+61.3%** Visitor Growth

------------------------------------------------------------------------

*Powered by* [**SATOM OÜ**](https://satom.eu/)
:::
